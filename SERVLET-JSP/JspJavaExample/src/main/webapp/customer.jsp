...
<body>
		<jsp:useBean id="cust" class="com.simplilearn.beans.Customer" scope="session">
			...
			<jsp:setProperty name="cust" property="cname" value="Priya"/>
			<jsp:setProperty name="cust" property="email" value="priya@simplilearn.com"/>
			<jsp:setProperty name="cust" property="phone" value="9898123"/>
		</jsp:useBean>
